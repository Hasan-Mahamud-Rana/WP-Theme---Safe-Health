...
register_nav_menus(
	array(
        ...
        'social-nav' => __( 'Social Menu', 'jointswp' ),   // Main nav in header
...
function joints_top_nav() {
	 wp_nav_menu(array(
        ...
        'menu_class' => 'vertical dropdown menu medium-horizontal',       // Adding custom nav class
