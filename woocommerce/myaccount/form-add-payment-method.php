...
<?php else : ?>
	<p class="woocommerce-notice woocommerce-notice--info woocommerce-info"><?php esc_html_e( 'Beklager, det ser ud til, at der ikke findes betalingsmetoder, der understøtter at tilføje en ny betalingsmetode. Kontakt os venligst, hvis du har brug for hjælp eller ønsker at lave alternative arrangementer.', 'woocommerce' ); ?></p>
<?php endif; ?>
