	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-total"><?php _e( 'Totaler', 'woocommerce' ); ?></th>
			</tr>
		</thead>
		<tbody>
		...
		<ul class="wc_payment_methods payment_methods methods">
			<?php
				if ( ! empty( $available_gateways ) ) {
					...
					echo '<li class="woocommerce-notice woocommerce-notice--info woocommerce-info">' . apply_filters( 'woocommerce_no_available_payment_methods_message', __( 'Beklager, det ser ud til, at der ikke er tilgængelige betalingsmetoder til din placering. Kontakt os venligst, hvis du har brug for hjælp eller ønsker at lave alternative arrangementer.', 'woocommerce' ) ) . '</li>';
				}
			?>
		</ul>
		<?php endif; ?>
